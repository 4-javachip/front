  ...
  return (
    <footer className=" mt-10">
      <div className="container mx-auto  ">
        {/* 상단 링크 (약관, 개인정보 보호) */}
        <div className=" pb-4 pt-5 pl-6  text-gray-500 flex justify-start space-x-4  bg-lightGray-3 font-SDGothic font-medium text-[11px]">
        ...
        {/* 저작권 정보 */}
        <div className="text-start text-xs bg-white px-4 pb-4 text-[#999999]">
